...
<div id="OSC_Banner">
    <div id="OSC_Slogon"><?php echo $name->username; ?>'s Blog</div>
    <div id="OSC_Channels">
        <ul>
            <li><a href="admin/user_setting" class="project"><?php echo $name->mood; ?></a></li>
        </ul>
    </div>
    <div class="clear"></div>
</div><!-- #EndLibraryItem -->
<div id="OSC_Topbar">
    <div id="VisitorInfo">
        当前访客身份：
        <?php echo $name->username; ?>[ <a href="welcome/logout">退出</a> ]
