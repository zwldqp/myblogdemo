...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Content">
		...
		<span class="comment">
		<div class="user"><b><?php echo $result->username; ?></b> 评论了 <a href="viewPost_comment.htm"
                                                                       target="_blank"><?php echo $result->title; ?></a></div>
		<div class="content"><p><?php echo $result->content; ?></p></div>
		<div class="opts">
			<span style="float:right;">
			<a href="admin/delete_comm?comm_id=<?php echo $result->comm_id?>">删除</a> |
			<a href="admin/delete_comm_user?user_id=<?php echo $result->user_id?>">删除此人所有评论</a>
			</span>
