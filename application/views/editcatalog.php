        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogCatalogManage">
                    <form id="CatalogForm" action="admin/update_type?id=<?php echo $row->type_id?> " method="post">
                        <h3> 修改博客分类 </h3>

                        <div id="error_msg" class="error_msg" style="display:none;"></div>
                        <label>分类名称:</label><input id="txt_link_name" name="name" value="<?php echo $row->type_name?>" size="15" tabindex="1"
                                                   type="text">
    <span class="submit">
                            ...
                            <?php foreach($results as $index=>$result){ ?>
                                <tr id="catalog_92334">
                                    ...
                                    <td class="opts">
                                        ...
                                        <a href="admin/delete_article_type?id=<?php echo $result->type_id?>" onclick="return delete_catalog(154693,92334);">删除</a>
                                    </td>
                                </tr>
                            <?php }?>
                            </tbody>
