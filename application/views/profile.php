    ...
    <div id="OSC_Content">
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                ...
                <div class="MainForm">
                    <form class="AutoCommitJSONForm" action="admin/update_user" method="POST">
                        <table>
                            <tbody>
                            <tr>
                                <th>登录帐号</th>
                            ...
                            <tr>
                                <th>会员名</th>
                                <td>
                                    <input name="name" size="20" maxlength="20" class="TEXT" value="<?php echo $name->username?>"
                                           type="text">
                            ...
                            <tr>
                                ...
                                <td><select onchange="showcity(this.value, document.getElementById('userCity'));"
                                    ...
                                    <script src="profile1_files/getcity.js"></script>
                                </td>
                            </tr>
                            <tr>
                                <th>个性签名<br>不超过100字</th>
                                <td><textarea name="mood" style="width: 300px; height: 100px;"
